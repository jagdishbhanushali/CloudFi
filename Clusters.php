...
?>
    ...
    <div class="alert alert-danger">
        <button type="button" class="close" data-dismiss="alert">×</button>
        Please run script at your machine before adding Cluster<a href="scriptCloud.sh" target="_blank"> Get Script </a>
    </div>
      ...
      <table class="table table-striped">
        ...
        <tbody>
        <?php
            $sql="select * from tblcluster where UserId=".$_SESSION['UserId'];
            $result=$db->query($sql);
